...
app.include_router(
    products.router, prefix=settings.API_V1_STR, tags=["products"]
)
app.include_router(
    suppliers.router, prefix=settings.API_V1_STR, tags=["suppliers"]
)
app.include_router(
    purchases.router, prefix=settings.API_V1_STR, tags=["purchases"]
)
...
app.include_router(
    businesses.router, prefix=settings.API_V1_STR, tags=["businesses"]
)
app.include_router(
...
app.include_router(
    inventory.router, prefix=settings.API_V1_STR, tags=["inventory"]
)
app.include_router(
...
app.include_router(
    briefings.router, prefix=settings.API_V1_STR, tags=["briefings"]
)
app.include_router(
